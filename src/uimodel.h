...
private:
  ...
  private:
    ...
    std::wstring m_VimInsertEscape;
    int m_VimInsertEscapeTimeoutMs = 0;
    int64_t m_VimInsertEscapeTimeMs = 0;
    std::string m_VimInsertEscapeProfileId;
    std::string m_VimInsertEscapeChatId;
    int m_VimInsertEscapePos = 0;
    ...
    {
      wint_t kind = 0;          // 'x' 'X' 'C' 'D' 'Y' '~' 'p' 'P' 'r' 'c' 'd' 'y'
      int count = 1;
